...
# Update catalog
w.catalogs.update(name="my_catalog", comment="Updated description", owner="admin@company.com")
...
# Update schema
w.schemas.update(full_name="main.analytics", comment="Updated analytics schema")
...
for summary in w.tables.list_summaries(
    catalog_name="main", schema_name_pattern="*", table_name_pattern="events*"
):
...
# Update table owner
w.tables.update(full_name="main.default.my_table", owner="new_owner@company.com")
...
# Update volume
w.volumes.update(name="main.default.my_volume", comment="Updated description")
