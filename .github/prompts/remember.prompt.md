...
Memory files are organized hierarchically by scope and domain:

**Global Scope:**
- `<global-prompts>/memory.instructions.md` - General cross-domain memories
- `<global-prompts>/.github/memories/{domain}-memory.instructions.md` - Domain-specific memories

**Workspace Scope:**
- `<workspace-instructions>/memory.instructions.md` - Workspace-wide general memories
- `<workspace-instructions>/{domain}-memory.instructions.md` - Workspace domain-specific memories
